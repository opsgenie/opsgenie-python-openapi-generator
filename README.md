# OpenAPI Generator for the geniepy library
...
For mac/linux:
```
java -cp /path/to/openapi-generator-cli.jar:/path/to/your.jar org.openapitools.codegen.OpenAPIGenerator generate -g geniepy -i /path/to/openapi.yaml -o ./test
```
...
You can also step through GeniepyGenerator.java in a debugger.  Just debug the JUnit
...
java -DdebugOperations -cp /path/to/openapi-generator-cli.jar:/path/to/your.jar org.openapitools.codegen.OpenAPIGenerator generate -g geniepy -i /path/to/openapi.yaml -o ./test
```
